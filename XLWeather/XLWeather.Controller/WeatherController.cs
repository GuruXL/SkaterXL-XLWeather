...
namespace XLWeather.Controller
{
    public class WeatherController : MonoBehaviour
    {
        ...
        private void GetPlayerTarget()
        {
            ...
            Transform parent = PlayerController.Main.gameplay.skaterController.gameObject.transform; // 1.2.6.0 // 1.2.7.8
            ...
            board = PlayerController.Main.gameplay.boardController.gameObject.transform; // 1.2.6.0 // 1.2.7.8
        }
